package com.devil.han.family_service_platform;
...
public class TestGenerator {
        ...
        public void testGenerator() {
            ...
            dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_service_platform?serverTimezone=UTC")
                    .setUsername("root").setPassword("654321");
            ...
            strategyConfig.setCapitalMode(true)//设置全局大写命名
                    ...
                    .setEntityLombokModel(true)//开启lombok支持
                    .setInclude();

            //包名配置
            PackageConfig packageConfig = new PackageConfig();
            packageConfig.setParent("com.devil.han").setMapper("mapper")
